...
- (IBAction)checkout:(id)sender
{
    ...
    [self.stackController pushViewController:billingInformationViewController withTransitionStyle:HLSTransitionStylePushFromRight];
}

- (IBAction)showDetails:(id)sender
{
    ProductViewController *productViewController = [[[ProductViewController alloc] init] autorelease];
    [self.stackController.placeholderViewController.stackController pushViewController:productViewController withTransitionStyle:HLSTransitionStyleFadeIn];
}
